...
//     var categorie = $(this).val(); // Récupérer la valeur sélectionnée
...
//         $('.photo-grid').html(response); // Mettre à jour la grille de photos
//       },
//     });
//   });
// });
...
// jQuery(document).ready(function ($) {
//   $('.filter-categorie, .filter-format').change(function () {
